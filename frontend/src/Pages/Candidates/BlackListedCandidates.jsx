                            ...
                            <tbody>
                              {loading? (
                                ...
                                candidatesList.map((candidate) => (
                                  <tr key={candidate.id} onClick={()=> {navigate(`/candidates/${candidate.id}?from=blacklisted`); localStorage.setItem('candidateFrom', 'blacklisted'); }} style={{cursor: 'pointer'}}>
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="dropdown-menu dropdown-menu-end m-0" onClick={(e)=>e.stopPropagation()}>
                                            <button className="dropdown-item"
                                              onClick={() => {
                                                  localStorage.setItem('candidateFrom', 'blacklisted');
                                                  navigate(`/candidates/${candidate.id}?from=blacklisted`);}}>View
                                            </button>
