...
export default function ExpiredInterview({type}) {
  ...
  return (
    ...
    <div className="container-xxl flex-grow-1 container-p-y">
      <div className='mb-4'>
        <p className='mb-2 text-black' style={{fontSize: '18px', fontWeight: '600'}}>Expired Interview List</p>
        <span>List of expired interviews</span>
      </div>
      <div className="card">
                            ...
                            <tbody>
                              {loading ? (
                                ...
                                interviewList.map((interview) => (
                                  <tr key={interview.id} onClick={()=> {navigate(`/interviewed/interview-list/${interview.id}?from=expired`);
                                    localStorage.setItem('interviewFrom', 'expired');}} style={{cursor: 'pointer'}}>
                                ...
                                <td className="dtr-hidden">
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="dropdown-menu dropdown-menu-end m-0" onClick={(e)=>e.stopPropagation()}>
                                            <button className="dropdown-item"
                                              onClick={() => {
                                                  localStorage.setItem('interviewFrom', 'expired');
                                                  navigate(`/interviewed/interview-list/${interview.id}?from=expired`);}}>View
                                            </button>
                                 ...
                                 <tr>
                                      <td colSpan="6" className="text-center">No expired interviews found</td>
                                </tr>
                              )}
                          </tbody>
                      </table>
