  ...
  return (
    <>
        ...
        <div className='container-fluid'>
            <div className='row flex-column flex-lg-row align-items-stretch'>
                <div className='col-lg-7 col-12' style={{ backgroundImage: 'url(../../assets/img/illustrations/bg-shape-image-light.png)',
                    ...
                    <img className='mt-4 img-fluid' src="/assets/img/illustrations/auth-register-illustration-light.png" alt='User Img' style={{height: '500px', width: '900px', objectFit: 'contain'}} />
                </div>
                <div className='col-lg-5 col-12 mt-lg-0 mt-5'>
                    <form action="" className="card px-4 mb-0 signUpForm" onSubmit={handleSubmit(onSubmit)} style={{backgroundColor: 'white'}}>
                                <div className="card-body pb-0 pt-1">
                                    <h2 className="fw-bold mb-0" style={{fontSize: '22px'}}>Adventure starts here 🚀</h2>
                                    ...
                                    <div className="mt-3 form-check">
                                        <input type="checkbox" className="me-2 form-check-input custom-checkbox" style={{borderColor: '#7367F0', marginTop: '0.1rem'}} id="Check" 
                                        {...register('terms', {required: true})} onChange={(e)=>setIsChecked(e.target.checked)}/> 
                                        <label className="form-check-label" htmlFor="Check" style={{fontWeight: '500'}}>I agree to <Link>privacy policy & terms</Link></label>
                                    </div>
                                    ...
                                    <div className='text-center mt-2'><span className='me-2'>Already have an account?</span><Link to="/login">SignIn Instead</Link></div>
